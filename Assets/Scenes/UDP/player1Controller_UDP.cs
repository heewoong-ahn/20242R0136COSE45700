...
public class player1Controller_UDP : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //udpClient = UDPClient.Instance.GetUdpClient(); //udpclient정보 가져옴. 
    ...
    void ProcessReceivedInputs()
    {
        ...
        while (UDPClient.Instance.inputQueue.Count > 0)
        {
            ...
            else if (inputData.playerId != gameData.playerId)
            {
                player.ApplyInput(inputData);
            }
        }
    }
